...
$ ll
\end{verbatim}
Check if the contents of that folder look similar to those of the gitlab repository. If everything looks all right, you're using Linux and want to do the plain installation (without plotting and LLL), just type the following in terminal
\begin{verbatim}
$ make
\end{verbatim}
