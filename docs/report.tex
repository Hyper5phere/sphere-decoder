...
\subsubsection{MIMO -- Alamouti 8-PAM}
\subsubsection{MIMO -- MIDO}
\subsubsection{SISO -- Spherical shaping}
...
\end{verbatim}
If this does not work please refer to \url{https://gcc.gnu.org/wiki/InstallingGCC} and \url{https://www.gnu.org/software/make/}. \par The next thing is to gather the required library packages:
\begin{enumerate}
